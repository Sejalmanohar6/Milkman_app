...
def update_image_urls(apps, schema_editor):
    ...
    for p in Product.objects.all():
        ...
        elif 'curd' in name or 'yogurt' in name or 'dahi' in name or 'buttermilk' in name:
            url = 'https://images.pexels.com/photos/35175194/pexels-photo-35175194.jpeg?auto=compress&cs=tinysrgb&w=1200'
        elif 'lassi' in name:
            url = 'https://images.pexels.com/photos/10874048/pexels-photo-10874048.jpeg?auto=compress&cs=tinysrgb&w=1200'
        elif 'ghee' in name:
...
class Migration(migrations.Migration):
    dependencies = [
        ('products', '0003_backfill_image_url'),
    ]
    operations = [
